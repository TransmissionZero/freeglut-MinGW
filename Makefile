...
DYNCFLAGS = -s -O2 -D FREEGLUT_EXPORTS -D NEED_XPARSEGEOMETRY_IMPL -D NDEBUG -D WINVER=0x0500 ${WARNS} -Iinclude/
DYNLDFLAGS = -s -shared -lopengl32 -lgdi32 -lwinmm
STATICCFLAGS = -s -O2 -D FREEGLUT_STATIC -D NEED_XPARSEGEOMETRY_IMPL -D NDEBUG -D WINVER=0x0500 ${WARNS} -Iinclude/
